...
class NewReservaStep2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_partici_step2.text = "El numero de Participantes es " + num_particif1
        ...
        bt_conti_to_step3.setOnClickListener {
            ...
            if (numpartici == num_particif1.toInt()){
                ...
                intent.putExtra("Numparticif1", num_particif1)
    ...
    private fun verificacionfireb(searchText: String?, j: Int) {
        ...
        myRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (!existedocu){
                    Toast.makeText(this@NewReservaStep2, "NO existe Usuario", Toast.LENGTH_SHORT).show()
